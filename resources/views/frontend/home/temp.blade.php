        ...
        <section class="text-light jarallax mx-2 rounded-1 overflow-hidden">
            <img src="/assets/images/background/1.webp" class="jarallax-img" alt="">
            <div class="sw-overlay op-6"></div>
        ...
        <section>
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="h-100 rounded-1 mh-300 wow fadeInUp" data-bgimage="url(/assets/images/misc/s1.webp) center"></div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item rooms">
                      <a href="/assets/images/gallery/1.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              ...
                              <img src="/assets/images/gallery/1.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item dining">
                      <a href="/assets/images/gallery/6.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/6.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item facilities">
                      <a href="/assets/images/gallery/9.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/9.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item rooms">
                      <a href="/assets/images/gallery/3.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/3.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item dining">
                      <a href="/assets/images/gallery/8.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/8.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item rooms">
                      <a href="/assets/images/gallery/5.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/5.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item facilities">
                      <a href="/assets/images/gallery/11.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/11.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item rooms">
                      <a href="/assets/images/gallery/2.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/2.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item facilities">
                      <a href="/assets/images/gallery/10.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/10.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item rooms">
                      <a href="/assets/images/gallery/4.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/4.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item dining">
                      <a href="/assets/images/gallery/7.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/7.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12 item facilities">
                      <a href="/assets/images/gallery/12.webp" class="image-popup d-block hover">
                          <div class="relative overflow-hidden rounded-1">
                              <div class="absolute start-0 w-100 hover-op-1 p-5 abs-middle z-3 text-center text-white">View</div>
                              <div class="absolute start-0 w-100 h-100 overlay-black-5 hover-op-1 z-2"></div>
                              <img src="/assets/images/gallery/12.webp" class="w-100 hover-scale-1-2" alt="">
                          </div>
                      </a>
                    </div>
